  ...
  exports.codearea = (area) ->
    ...
    key_bracket = (bracket) ->
      ...
      if now.same
        ...
        {a_row, a_col, b_row, b_col, lines} = now
        line = lines[a_row]
        lines[a_row] = line[...a_col] + '(' + line[a_col..]
        a_col += 1
        b_col += 1 if a_row is b_row
        line = lines[b_row]
        lines[b_row] = line[...b_col] + ')' + line[b_col..]
        console.log lines
        write_text area, {a_row, a_col, b_row, b_col, lines}
        false
